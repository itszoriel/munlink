    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 px-6 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          />
          <h1 className="text-2xl font-serif font-bold text-gray-900">Set a new admin password</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          {validating ? (
            ...
            <div className="text-center space-y-4">
              ...
              <Link
                to="/"
                className="inline-block px-4 py-2 text-sm rounded-lg bg-blue-600 text-white hover:bg-blue-700"
              >
                Back to portal
              </Link>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-12 px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all bg-gray-50 focus:bg-white"
                    value={password}

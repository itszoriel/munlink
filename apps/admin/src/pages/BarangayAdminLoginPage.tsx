...
import { MapPin, Megaphone, Users, ArrowLeft } from 'lucide-react'

export default function BarangayAdminLoginPage() {
  ...
  const features = [
    { icon: MapPin, label: 'Local Community Focus', desc: 'Manage your barangay communications' },
    { icon: Megaphone, label: 'Community Updates', desc: 'Share local announcements and alerts' },
    { icon: Users, label: 'Resident Engagement', desc: 'Connect with your community' },
  ]
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.role !== 'barangay_admin') {
        setError('This account is not authorized for barangay admin access. Please use the correct login page for your role.')
        setLoading(false)
        return
      }
  ...
  return (
    <div className="fixed inset-0 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative overflow-hidden">
        <img
          src="/assets/barangay.jpg"
          alt="Barangay Admin Login"
          ...
          <div className="max-w-lg">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h1 className="text-4xl font-serif font-bold text-white mb-1">Barangay Admin</h1>
                  <p className="text-emerald-100 text-lg">Community Portal</p>
                </div>
              </div>
              <p className="text-white/90 text-lg leading-relaxed">
                Connect with your community. Manage barangay-level announcements and engage with residents.
              </p>
            </motion.div>
            ...
            <div className="lg:hidden mb-8 text-center">
              <div className="inline-flex items-center gap-3 mb-4">
                ...
                <div className="text-left">
                  <h1 className="text-2xl font-serif font-bold text-gray-900">Barangay Admin</h1>
                  <p className="text-sm text-gray-600">Community Portal</p>
                </div>
              </div>
            </div>

            <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcome back</h2>
            <p className="text-gray-600 mb-8">Sign in to manage your barangay</p>

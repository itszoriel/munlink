...
try:
    ...
    from utils.pdf_generator import _resolve_logo_paths, _draw_header, _draw_watermark, _draw_border
...
def _draw_header_footer(c: canvas.Canvas, title: str, municipality_name: str, page_w: int, page_h: int):
    ...
    c.setFillColor(colors.grey)
    c.drawCentredString(page_w/2, 16*mm, f"Generated by MunLink Region III • {datetime.utcnow().strftime('%Y-%m-%d %H:%M UTC')}")
